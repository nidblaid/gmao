# -*- coding: utf-8 -*-
{
    ...
    'summary': """
        Sales Analytics module is an extension for Sales business applications""",
    ...
    'depends': ['base','base_automation', 'base_setup', 'contacts', 'sale_management', 'stock','crm','hr','hr_attendance'],
